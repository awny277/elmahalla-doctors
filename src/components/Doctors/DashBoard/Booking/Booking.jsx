  ...
  return (
    <React.Fragment>
      <div className="BookingDoctor">
        ...
        <h2 className="booking-header">مواعيد الحجوزات</h2>
        <div className="BookingContainer">
          <NavLink
            to="/dashBoard/bookingDoctor/ToDay"
            className="todayLink BookingDoctorTabs"
          >
            اليوم
          </NavLink>
          <NavLink
            to="/dashBoard/bookingDoctor/UpComing"
            className="WaitingLink BookingDoctorTabs"
          >
            الأنتظار
          </NavLink>
          <Switch>
